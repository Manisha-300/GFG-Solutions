<h2><a href="https://www.geeksforgeeks.org/problems/minimum-swaps/1?sortBy=submissions&category%5B%5D=Sorting&page=1&difficulty%5B%5D=1">Minimum Swaps to Sort</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given an array <strong>arr[]</strong> of distinct elements. Find the minimum number of swaps required to sort the array in strictly increasing order.</span></p>
